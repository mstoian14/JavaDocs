...
public class Exercise3 {
    ...
    public void addElementsToSets(){
        ...
        Set<String> stringSetLinkedHashSet = new LinkedHashSet<String>();
        Set<String> stringTreeSet = new TreeSet<String>();
        for(String s : listToAdd) {
            stringHashSet.add(s);
            stringSetLinkedHashSet.add(s);
            stringTreeSet.add(s);
        }
        ...
        System.out.println(stringSetLinkedHashSet);
        ...
        stringTreeSet.add("that");
        stringTreeSet.add("no");
