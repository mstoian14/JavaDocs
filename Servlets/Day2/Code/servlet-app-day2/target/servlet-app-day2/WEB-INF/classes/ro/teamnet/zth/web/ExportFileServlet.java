...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for(String param : paramNameList) {
            paramsMap.put(param, valueOf(request.getParameterValues(param)));
        }
        ...
        try (InputStream reportStream = getClass().getResourceAsStream(jasperPath)) {
            ...
            response.setContentType(passedFileType);
            response.setHeader( "Content-Disposition", "filename=" + passedTemplate );
