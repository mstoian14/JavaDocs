...
public class FiltersAndMapExercise {
    ...
    public static List<String> findPersonByName(String name){
        ...
        personName = input.filter(nume -> nume.equals(name)).collect(Collectors.toList());
    ...
    public static List<Person> findPersonByAgeAndName(List<Person> personList, String name, Integer age){
        ...
        persons = personList.stream().filter(value -> value.getAge() == age && value.getName().equals(name)).collect(toList());
        return persons;
    }
    ...
    public static List<String> getOnlyNames(List<Person> personList){
        ...
        //TODO #6
        // HINT: use map
        collect = personList.stream().map(p -> p.getName()).collect(toList());
    ...
    public static List<Integer> flatteningLists() {
        ...
        together = input.flatMap(t->t.stream()).collect(toList());
    ...
    public static int product(){
        ...
        int product = 1;
        //TODO #8
        product = input.reduce(1,(acc,el) -> acc*el);
        return product;
    }
    ...
    public static boolean areAllPersonsBelowAge(List<Person> personList, Integer age){
        ...
        //TODO #10 use allMAtch - varsta sub 70
    ...
    public static int findTheMinimumNumber(){
        ...
        //TODO #11 cel mai mic numar din streamul dat
        // HINT: use reduce
        int min = 99999;
    ...
    public static int findTheYoungestPerson(List<Person> personList){
        ...
        //TODO #12
        // HINT: use map and reduce cea mai tanara persoana din lista
        int min = 0;
        min = personList.stream().mapToInt(Person::getAge).reduce(Integer.MAX_VALUE, Integer::min);
        return min;
    }
    ...
    public static Optional<Integer> findSquareDivisibleBy3(){
        ...
        //primul patrat perfect care se divide cu 3 din lista
